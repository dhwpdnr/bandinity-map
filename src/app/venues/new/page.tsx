  ...
  return (
    <div className="flex min-h-dvh flex-col bg-zinc-50 dark:bg-zinc-950">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-6 pb-12">
        <div className="mb-5 flex items-start gap-3 rounded-xl border-l-4 border-primary-400 bg-zinc-50 px-4 py-3 text-sm text-zinc-600 dark:bg-zinc-800/50 dark:text-zinc-400">
